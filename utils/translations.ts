...
export const translations = {
  uz: {
    ...
    myOrdersBtn: "Mening Buyurtmalarim",
    ...
    statusBusy: "Band (Navbatda)",
    statusReviewing: "Ko'rilmoqda",
    statusCompleted: "Ko'rildi / Tayyor",
  ...
  ru: {
    ...
    statusBusy: "Занят (В очереди)",
    statusReviewing: "Рассматривается",
    statusCompleted: "Готово / Просмотрено",
  ...
  en: {
    ...
    statusBusy: "Busy (In Queue)",
    statusReviewing: "Reviewing",
    statusCompleted: "Completed / Seen",
